contract WhitelistContract {
    ...
    */
    function addManyToWhitelist(address[] _investors) external onlyOwner {
    ...
    */
    ...
    function buyTokens(address _investor, uint256 _weiAmount) public isWhitelisted(_investor) {
        // ..
    }
}